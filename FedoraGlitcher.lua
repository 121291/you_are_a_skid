...
if Char:FindFirstChild("ass xd") then
	...
	local HatChoice = Char:FindFirstChild("ass xd")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
...
if Char:FindFirstChild("InternationalFedora") then
	...
	local HatChoice = Char:FindFirstChild("InternationalFedora")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
...
if Char:FindFirstChild("13thFedora") then
	...
	local HatChoice = Char:FindFirstChild("13thFedora")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
...
if Char:FindFirstChild("13thFedora") then
	...
	local HatChoice = Char:FindFirstChild("fuck xd")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
...
if Char:FindFirstChild("MeshPartAccessory") then
	...
	local HatChoice = Char:FindFirstChild("MeshPartAccessory")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
