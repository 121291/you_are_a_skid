...
True-Love - DEATH
		...
		local modeInfo={
			...
			{Name="P O W E R",Walkspeed=45,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(174, 122, 89);Music=3080022158,LeftWing={0,BrickColor.new'Neon orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='NebG4'};
			...
			{Name="Sonic",Walkspeed=270,moveVal=20,Font=Enum.Font.Fantasy,StrokeColor=C3.RGB(13, 105, 172);Music=144304272,LeftWing={0,BrickColor.new'Bright blue'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Bright blue'.Color,Enum.Material.Neon};WingAnim='StarA'};
...
LWP1W.C0 = LWP1W.C0:lerp(CF.N(0.49,7,8)*CF.A(M.R(5+300*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
   ...
   div=div or 1
		...
		WingAnims.NebG4=function(div)
			div=div or 1
		LWP1W.C0 = LWP1W.C0:lerp(CF.N(0,8,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+2000*M.R(WingSine/div))),.2)
			LWP2W.C0 = LWP2W.C0:lerp(CF.N(0,8,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120+2000*M.R(WingSine/div))),.2)
			LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,8,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120+2000*M.R(WingSine/div))),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(0,8,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-2000*M.R(WingSine/div))),.2)
			RWP2W.C0 = RWP2W.C0:lerp(CF.N(0,8,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120-2000*M.R(WingSine/div))),.2)
			RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,8,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120-2000*M.R(WingSine/div))),.2)
		end
				...
				elseif(Mode=='P O W E R')then
					...
					if(NeutralAnims)then	
						GotEffect{
							...
							Color=BrickColor.new'orange'.Color;
							Transparency={.5,1};
							Material=Enum.Material.Neon;
