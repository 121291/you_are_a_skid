...
--[[
EXTRAORDINARY - Astronaut - Lost Soul
=_-CalmNess-_=
DESTINY - ATLANTIS
BEYOND - Th1rt3en
TROLLGE - Vanta Black
...
local modeInfo={
	...
	{Name="UNDEAD",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=2642108668,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarEL'};
	...
	{Name="EXTRAORDINARY",Walkspeed=16,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=5119156054,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='NebG1'};
	...
	{Name="Mayhem",Walkspeed=18,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=1842932918,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='StarLTE'};
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.C and Mode=='Mayhem')then
		changeMode'Mayhem'
	elseif(io.KeyCode == Enum.KeyCode.V and Mode=='Mayhem')then
		changeMode'N U C L E A R - WASTE'
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Mayhem')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='N U C L E A R - WASTE')then 
		changeMode'D O O M'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='Mayhem')then
